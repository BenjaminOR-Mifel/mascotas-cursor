...
```ssh
modyo-cli get --organization=modyo-connect mifel-mx-widgets-base@main WIDGET_NAME
```

Desde github.com, crear un repositorio a partir de este template.

## Ajustes sobre repositorio creado

1. ~~Reemplazar mifel-mx-widgets-base en `package.json` (bugs, homepage, repository.url y name) y en `sonar-project.properties`.~~
2. ~~Reemplazar en `Readme.md` WIDGET_NAME con el nombre del repositorio.~~
3. Verificar la versión de commons del `package.json` (si es necesario, recordar actualizar este template).
4. ~~Solicitar acceso de lectura al package `mifel-mx-widgets-commons` en GitHub (https://github.com/orgs/modyo-connect/packages/npm/mifel-mx-widgets-commons/settings).~~
5. ~~Reemplazar el nombre del widget en el id de los div de `public/index.html` y `modyo-public/index.html`. También en el mount de `src/main.js`.~~
6. ~~Solicitar SonarCloud con "Previous version" y "Quality Gate" con "Sonar way no tests".~~
7. ~~Crear rama develop a partir de main y dejar como default.~~
8. ~~Setup en GitHub: Solicitar configuración de environments en GitHub, verificación de protección de ramas y secretos.~~
9. Descargar repositorio e instalar dependencias para actualizar el `package-lock.json`.
10. Revisar que todos los GitHub Actions estén ok.
11. Borrar esta sección del `Readme.md`.

Para empresas usar https://github.com/modyo-connect/mifel-mx-widgets-base-empresas.

# mifel-mx-widgets-pb-pf-onboarding-n2n4-v2
## Tabla de contenido
...
```
git clone git@github.com:modyo-connect/mifel-mx-widgets-pb-pf-onboarding-n2n4-v2.git
```
...
[(DFS)](<https://www.figma.com/file/KNX69UhdhJX3adiwJUM0Bo/DFS-%7C-Dashboard-%2B-Show-de-cuentas-PF?type=whiteboard&node-id=2564-50886&t=BFoOnHqfAgpirMmH-4>)
...
Mostraremos un listado del manejo de los errores a los que esta suscrito el widget y como este los aborda.

| ID  | SERVICIO        | CODE | DESCRIPCIÓN                                        | ACCIÓN            |
| :-- | :-------------- | :--- | :------------------------------------------------- | :---------------- |
| XX | service-name | YYYY | Error description | Type (Toast) |
...
[Ver Miro](https://miro.com/app/board/uXjVPUqY00U=/?moveToWidget=3458764537544999477&cot=14)
...
[Ver Figma](https://www.figma.com/proto/hjpkmK8nGlMTJLR4QbJWA2/PD-%7C-Dashboard-%2B-Cuentas-PF?type=design&node-id=2171-43410&t=ZK9grezrXCFif514-0&scaling=scale-down&page-id=1%3A3&starting-point-node-id=1629%3A39761&show-proto-sidebar=1|https://www.figma.com/file/hjpkmK8nGlMTJLR4QbJWA2/PD-%7C-Dashboard-%2B-Cuentas-PF?type=design&node-id=1-2&mode=design&t=ZKYMKJzJEdlpbcyJ-0|smart-link)
...
[Ver Diagrama de flujo](https://github.com/modyo-connect/mifel-mx-widgets-commons/blob/develop/GITFLOW.md)
